...
class ControlPanel(QtGui.QGroupBox):
	...
	def __init__(self, parent, midiinputs, midioutputs, scales, keynames):
		...
		self.change_channel = {
				"LEFT" : self.change_left_channel,
				"RIGHT" : self.change_right_channel
				}

		self.label_scaleit = {}
		self.spinbox_scaleit = {}
		self.change_scaleit = {
				"LEFT" : self.change_left_scaleit,
				"RIGHT" : self.change_right_scaleit
				}

		self.label_program = {}
		self.spinbox_program = {}
		self.change_program = {
				"LEFT" : self.change_left_program,
				"RIGHT" : self.change_right_program
				}

		self.label_minpitch = {}
		self.spinbox_minpitch = {}
		self.change_minpitch = {
				"LEFT" : self.change_left_minpitch,
				"RIGHT" : self.change_right_minpitch
				}

		self.label_maxpitch = {}
		self.spinbox_maxpitch = {}
		self.change_maxpitch = {
				"LEFT" : self.change_left_maxpitch,
				"RIGHT" : self.change_right_maxpitch
				}
	...
	def change_left_channel(self,val):
		self.parent.set_channel(val,"LEFT")

	def change_right_channel(self,val):
		self.parent.set_channel(val,"RIGHT")
	...
	def change_left_scaleit(self,val):
		print "CHANGE_LEFT_SCALEIT! val=",val
		self.parent.set_scaleit(val,"LEFT")

	def change_right_scaleit(self,val):
		print "CHANGE_RIGHT_SCALEIT! val=",val
		self.parent.set_scaleit(val,"RIGHT")
	...
	def change_left_program(self,val):
		self.parent.set_program(val,"LEFT")

	def change_right_program(self,val):
		self.parent.set_program(val,"RIGHT")
	...
	def change_left_minpitch(self,val):
		self.parent.set_minpitch(val,"LEFT")

	def change_right_minpitch(self,val):
		self.parent.set_minpitch(val,"RIGHT")
	...
	def change_left_maxpitch(self,val):
		self.parent.set_maxpitch(val,"LEFT")

	def change_right_maxpitch(self,val):
		self.parent.set_maxpitch(val,"RIGHT")
...
class MidiFingers(QtGui.QWidget):
	...
	def __init__(self):
		...
		self.channel = { "LEFT":0, "RIGHT":0 }
		self.program = { "LEFT":0, "RIGHT":0 }
		self.minpitch = { "LEFT":0, "RIGHT":0 }
		self.maxpitch = { "LEFT":0, "RIGHT":0 }
		self.scaleit = { "LEFT":0, "RIGHT":0 }
		...
		self.set_channel(10,"LEFT")
		self.set_scaleit(0,"LEFT")
		self.set_program(1,"LEFT")
		self.set_minpitch(37,"LEFT")
		self.set_maxpitch(59,"LEFT")

		self.set_channel(1,"RIGHT")
		self.set_scaleit(1,"RIGHT")
		self.set_program(1,"RIGHT")
		self.set_minpitch(40,"RIGHT")
		self.set_maxpitch(100,"RIGHT")
